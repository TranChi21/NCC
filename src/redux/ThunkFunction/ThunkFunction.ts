...
export const getAllProject = createAsyncThunk(
  ...
  async (data: IParamsForAllProject) => {
    const params =
...
export const getProjectQuantity = createAsyncThunk(
  'project/projectQuantitty',
  async () => {
...
export const CreateProject = createAsyncThunk(
  ...
  async (ProjectData: IProjectSubmitValue) => {
...
export const DeleteProject = createAsyncThunk(
  ...
  async (projectId: number) => {
    await axiosClient.delete(
      `/api/services/app/Project/Delete?Id=${projectId}`
    );
    return projectId;
  }
);
